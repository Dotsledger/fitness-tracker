// ============================================================================
// Iconos · set SVG inline (trazo 2px, 24×24, estilo Lucide) con currentColor.
// Sustituye a los emojis: se renderizan igual en todos los dispositivos, heredan
// el color del texto y escalan con los tokens de tamaño.
// ============================================================================
...
const PATHS = {
  ...
  weight: "M12 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM6.5 8a2 2 0 0 0-1.905 1.46L2.1 18.5A2 2 0 0 0 4 21h16a2 2 0 0 0 1.925-2.54L19.4 9.5A2 2 0 0 0 17.48 8z",
  ...
  calculator: "M6 2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zM8 6h8M16 14v4M16 10h.01M12 10h.01M8 10h.01M12 14h.01M8 14h.01M12 18h.01M8 18h.01",
  ...
  package: "m7.5 4.27 9 5.15M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16zM3.3 7l8.7 5 8.7-5M12 22V12",
...
// Devuelve un <svg> listo para insertar. Decorativo por defecto (aria-hidden);
// pasa { label } cuando el icono va solo y debe tener nombre accesible.
export function icon(name, size = 20, opts = {}) {
  ...
  svg.setAttribute("class", ("ico" + (opts.class ? " " + opts.class : "")).trim());
  if (opts.label) {
